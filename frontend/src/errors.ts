...
export function friendlyError(cause:unknown,fallback="The requested operation could not be completed"):string{
  ...
  if(/wallet_(?:get|request)Snaps|wallet snap/i.test(raw))return "This wallet does not expose the required signing method. Use an EIP-1193 wallet connected to the network shown in VeriStep.";
