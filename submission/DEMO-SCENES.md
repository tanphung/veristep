...
3. Happy Path, 20 seconds: validator decision, provenance and exact citations.
...
- Keep the browser at a readable desktop viewport.
- Use slow scrolls and short pauses after each state change.
- Do not show browser chrome, external websites, source code, Explorer, terminals or dashboards.
- Do not connect a wallet or create a transaction.
